...
| <div style="text-align:center; color:#9467bd;" rowspan="6">**JavaScript Basics**</div> | Teacher Bot | JavaScript Beginner Practice | A simple JavaScript project demonstrating the use of variables and string manipulation in a chatbot-like interface. | [![Repo](https://img.shields.io/badge/View-Repo-blue?logo=github)](https://github.com/karianjahi/teacher-bot) |
