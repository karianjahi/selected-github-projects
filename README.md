...
|  | 5️⃣4️⃣ Spinal Case Converter | 🧩 Regex • String Transformation | A lightweight JavaScript utility that converts strings into spinal-case (kebab-case) using positive lookahead and separator normalization. |
