...
| <div style="text-align:center; color:#9467bd;" rowspan="9">**JavaScript Basics**</div> | Teacher Bot | JavaScript Beginner Practice | A simple JavaScript project demonstrating the use of variables and string manipulation in a chatbot-like interface. | [![Repo](https://img.shields.io/badge/View-Repo-blue?logo=github)](https://github.com/karianjahi/teacher-bot) |
|  | Sentence Maker | JavaScript Beginner Project | A mini project practicing `console.log()`, variables (`const` & `let`), and string concatenation to build sentences dynamically. | [![Repo](https://img.shields.io/badge/View-Repo-blue?logo=github)](https://github.com/karianjahi/sentence-maker) |
...
|  | MathBot | JavaScript Math Fundamentals | Interactive bot demonstrating the JavaScript `Math` object, including random numbers, rounding, max/min, and basic exercises for beginners. | [![Repo](https://img.shields.io/badge/View-Repo-blue?logo=github)](https://github.com/karianjahi/mathbot) |
|  | Fortune-Teller | Random Fortune Generator | Fun JavaScript project practicing logic, conditional statements, and randomness to display a fortune in the console. | [![Repo](https://img.shields.io/badge/View-Repo-blue?logo=github)](https://github.com/karianjahi/fortune-teller) |
|  | Basic Math Functions | JavaScript Math Practice | Beginner-friendly project implementing simple math operations such as addition ➕, subtraction ➖, multiplication ✖️, division ➗, squaring 🔢, and square roots √, demonstrating function definitions and usage in JavaScript. | [![Repo](https://img.shields.io/badge/View-Repo-blue?logo=github)](https://github.com/karianjahi/basic-math-functions) |
|  | JavaScript Functions Fundamentals | JavaScript Practice | Collection of small, fundamental JavaScript functions for learning and practicing basics, inspired by freeCodeCamp exercises. | [![Repo](https://img.shields.io/badge/View-Repo-blue?logo=github)](https://github.com/karianjahi/js-functions-fundamentals) |
...
|  | Moon Orbit Animation | CSS Animation | Animation of the moon orbiting around the earth using HTML and CSS keyframes. | [![Repo](https://img.shields.io/badge/View-Repo-blue?logo=github)](https://github.com/karianjahi/moon-orbit-animation) |
...
|  | City Skyline with CSS Variables | Creative Coding | A skyline built using HTML and CSS with emphasis on CSS variables. | [![Repo](https://img.shields.io/badge/View-Repo-blue?logo=github)](https://github.com/karianjahi/css-variables-build-city-skyline) |
...
|  | Basic Piano Layout | Interactive Layout | Piano layout to demonstrate responsiveness for various devices. | [![Repo](https://img.shields.io/badge/View-Repo-blue?logo=github)](https://github.com/karianjahi/basic-responsive-piano) |
...
|  | Balance Sheet | Tabular Layout | Demonstrates CSS attribute selectors in a balance sheet layout. | [![Repo](https://img.shields.io/badge/View-Repo-blue?logo=github)](https://github.com/karianjahi/css-attribute-selectors-balance-sheet) |
...
|  | Webpage Quiz | Accessibility Design | A webpage quiz to demonstrate Accessible Rich Internet Applications (ARIA). | [![Repo](https://img.shields.io/badge/View-Repo-blue?logo=github)](https://github.com/karianjahi/css-accessibility-webpage-quiz) |
...
|  | Nutrition Labels | Semantic Design | Demonstration of semantic HTML elements and typography using nutrition labels. | [![Repo](https://img.shields.io/badge/View-Repo-blue?logo=github)](https://github.com/karianjahi/css-typography-nutrition-labels) |
...
|  | Confidential Email Page | Box Model Styling | Simple confidential email message to demonstrate the Box Model in CSS. | [![Repo](https://img.shields.io/badge/View-Repo-blue?logo=github)](https://github.com/karianjahi/confidential-email-page) |
...
|  | Contact Form | Form Design | A contact form built to illustrate styling forms in CSS. | [![Repo](https://img.shields.io/badge/View-Repo-blue?logo=github)](https://github.com/karianjahi/contact_form) |
...
|  | Colored Boxes | Color Theory | A repo demonstrating various ways to apply color in CSS. | [![Repo](https://img.shields.io/badge/View-Repo-blue?logo=github)](https://github.com/karianjahi/css-colored-boxes) |
...
|  | Job Application Form | Basic HTML Forms | Creating a basic form in HTML. | [![Repo](https://img.shields.io/badge/View-Repo-blue?logo=github)](https://github.com/karianjahi/job-application-form) |
